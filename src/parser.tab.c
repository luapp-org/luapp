...
{
  "$end", "error", "$undefined", "IDENTIFIER_T", "INTEGER_T", "STRING_T",
  ...
  "PLUS_T", "MINUS_T", "ASTERISK_T", "SLASH_T", "EQUAL_T", "LEFT_PARAN_T",
  "RIGHT_PARAN_T", "CARROT_T", "GREATER_THAN_T", "LESS_THAN_T",
  "SQUIGGLE_T", "COLON_T", "POUND_T", "DOT_T", "DOUBLE_EQUAL_T",
  "NOT_EQUAL_T", "GREATER_EQUAL_T", "LESS_EQUAL_T", "CONCAT_T", "VARARG_T",
  "$accept", "identifier", YY_NULLPTR
};
#endif
